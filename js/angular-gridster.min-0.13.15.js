        ...
        .controller('GridsterCtrl', ['gridsterConfig', '$timeout',
            function (gridsterConfig, $timeout) {
                ...
                this.getItems = function (row, column, sizeX, sizeY, excludeItems) {
                    ...
                    if (this.sparse === false) { // check all cells
                        ...
                        for (var i = 0; i < this.allItems.length; ++i) {
                            ...
                            if (item && (!excludeItems || excludeItems.indexOf(item) === -1) &&
                                items.indexOf(item) === -1 &&
                                this.intersect(item, column, right, row, bottom)) {
                                items.push(item);
                            }
                        }
                    }
                    ...
                    while (row > -1) {
                        ...
                        while (col > -1) {
                            ...
                            if (items) {
                                var item = items[col];
                                if (item && (!excludeItems || excludeItems.indexOf(item) === -1) &&
                                    item.sizeX >= sizeX && item.sizeY >= sizeY) {
                                    return item;
                                }
                            }
                            ++sizeX;
                ...
                this.updateHeight = function (plus) {
                    ...
                    this.gridHeight =
                        this.maxRows - maxHeight > 0 ? Math.min(this.maxRows, maxHeight) :
                            Math.max(this.maxRows, maxHeight);
                };
                ...
                link: function (scope, $el, attrs, gridster) {
                    ...
                    scope.previewStyle = function () {
                        ...
                        return {
                            ...
                            top: (gridster.movingItem.row * gridster.curRowHeight +
                            (gridster.outerMargin ? gridster.margins[0] : 0)) + 'px',
                            left: (gridster.movingItem.col * gridster.curColWidth +
                            (gridster.outerMargin ? gridster.margins[1] : 0)) + 'px'
                        };
                    };
                }
            };
                        ...
                        return function (scope, $elem, attrs, gridster) {
                            ...
                            function updateHeight() {
                                $elem.css('height', (gridster.gridHeight * gridster.curRowHeight) +
                                    (gridster.outerMargin ? gridster.margins[0] :
                                        -gridster.margins[0]) + 'px');
                            }
                            ...
                            function refresh(config) {
                                ...
                                if (gridster.colWidth === 'auto') {
                                    gridster.curColWidth = (gridster.curWidth +
                                        (gridster.outerMargin ? -gridster.margins[1] :
                                            gridster.margins[1])) / gridster.columns;
                                } else {
                                ...
                                gridster.isMobile = gridster.mobileModeEnabled &&
                                    gridster.curWidth <= gridster.mobileBreakPoint;
                            ...
                            var resize = function () {
                                ...
                                $rootScope.$broadcast('gridster-resized', [width, $elem[0].offsetHeight],
                                    gridster);
                            };
        ...
        .controller('GridsterItemCtrl', function () {
            ...
            this.setElementPosition = function () {
                if (this.gridster.isMobile) {
                    ...
                    this.$element.css({
                        margin: 0,
                        top: (this.row * this.gridster.curRowHeight +
                        (this.gridster.outerMargin ? this.gridster.margins[0] : 0)) + 'px',
                        left: (this.col * this.gridster.curColWidth +
                        (this.gridster.outerMargin ? this.gridster.margins[1] : 0)) + 'px'
                    });
                }
            };
            ...
            return function GridsterTouch(target, startEvent, moveEvent, endEvent) {
                ...
                var computeDocumentToElementDelta = function (theElement) {
                    ...
                    for (var offsetElement = theElement; offsetElement != null; offsetElement = offsetElement.offsetParent) {
                        ...
                        if (oldIEUserAgent &&
                            ...
                            offsetElement.currentStyle.position === 'relative' && offsetElement.offsetParent &&
                            offsetElement.offsetParent.currentStyle.position === 'relative' &&
                            offsetElement.offsetLeft === offsetElement.offsetParent.offsetLeft) {
                            // add only the top
                ...
                var doEvent = function (theEvtObj) {
                    ...
                    for (var i = 0; i < pointerList.length; ++i) {
                        ...
                        var pointerId = (typeof pointerObj.identifier !== 'undefined') ? pointerObj.identifier :
                            (typeof pointerObj.pointerId !== 'undefined') ? pointerObj.pointerId : 1;
                        ...
                        if (typeof pointerObj.pageX === 'undefined') {
                            ...
                            if (pointerObj.srcElement.offsetParent === target && document.documentMode &&
                                document.documentMode === 8 && pointerObj.type === 'mousedown') {
                                ...
                                for (var scrollElement = pointerObj.srcElement; scrollElement !== null;
            ...
            function ($document, $window, GridsterTouch) {
                function GridsterDraggable($el, scope, gridster, item, itemOptions) {
                    ...
                    function drag(event) {
                        ...
                        var itemsInTheWay = gridster.getItems(row, col, item.sizeX, item.sizeY,
                            item);
                        var hasItemsInTheWay = itemsInTheWay.length !== 0;

                        if (gridster.swapping === true && hasItemsInTheWay) {
                            var boundingBoxItem = gridster.getBoundingBox(itemsInTheWay),
                                sameSize = boundingBoxItem.sizeX === item.sizeX &&
                                    boundingBoxItem.sizeY === item.sizeY,
                                sameRow = boundingBoxItem.row === oldRow,
                                sameCol = boundingBoxItem.col === oldCol,
                                samePosition = boundingBoxItem.row === row &&
                                    boundingBoxItem.col === col,
                            ...
                            if (sameSize && itemsInTheWay.length === 1) {
                            ...
                            } else if (boundingBoxItem.sizeX <= item.sizeX &&
                                boundingBoxItem.sizeY <= item.sizeY && inline) {
                                ...
                                for (var i = 0, l = itemsInTheWay.length; i < l; ++i) {
                                    ...
                                    if (itemsInFreeSpace.length === 0) {
                                        gridster.putItem(itemInTheWay, itemInTheWay.row + rowOffset,
                                            itemInTheWay.col + colOffset);
                                    }
                                }
                            }
                        ...
                        if (event.pageY - realdocument.body.scrollTop < scrollSensitivity) {
                            ...
                            (event.pageY - realdocument.body.scrollTop) < scrollSensitivity) {
                            realdocument.body.scrollTop = realdocument.body.scrollTop + scrollSpeed;
                        }
                        ...
                        if (event.pageX - realdocument.body.scrollLeft < scrollSensitivity) {
                            ...
                            (event.pageX - realdocument.body.scrollLeft) <
                            scrollSensitivity) {
                            realdocument.body.scrollLeft = realdocument.body.scrollLeft + scrollSpeed;
                        }
                    ...
                    function mouseDown(e) {
                        ...
                        if (gridster.draggable && gridster.draggable.handle) {
                            var $dragHandles = angular.element(
                                $el[0].querySelectorAll(gridster.draggable.handle));
                            var match = false;
                            outerloop:
                    ...
                    function mouseMove(e) {
                        if (!$el.hasClass('gridster-item-moving') ||
                            $el.hasClass('gridster-item-resizing')) {
                            return false;
                        }
            ...
            function GridsterResizable($el, scope, gridster, item, itemOptions) {
                ...
                function ResizeHandle(handleClass) {
                    ...
                    function resize(e) {
                        ...
                        var isChanged = item.row !== oldRow || item.col !== oldCol || item.sizeX !== oldSizeX ||
                            item.sizeY !== oldSizeY;
                    ...
                    this.enable = function () {
                        if (!$dragHandle) {
                            $dragHandle =
                                angular.element('<div class="gridster-item-resizable-handler handle-' + hClass + '"></div>');
            ...
            function ($parse, GridsterDraggable, GridsterResizable, gridsterDebounce) {
                return {
                    ...
                    link: function (scope, $el, attrs, controllers) {
                        ...
                        var aspects = ['minSizeX', 'maxSizeX', 'minSizeY', 'maxSizeY', 'sizeX', 'sizeY',
                                'row', 'col'],
                            $getters = {};
                        ...
                        scope.$watch(function () {
                            return item.sizeY + ',' + item.sizeX + ',' + item.minSizeX + ',' +
                                item.maxSizeX + ',' + item.minSizeY + ',' + item.maxSizeY;
                        }, sizeChanged);
                        ...
                        var updateResizable = function () {
                            resizable.toggle(
                                !gridster.isMobile && gridster.resizable && gridster.resizable.enabled);
                        };
                        updateResizable();

                        var updateDraggable = function () {
                            draggable.toggle(
                                !gridster.isMobile && gridster.draggable && gridster.draggable.enabled);
                        };
                        updateDraggable();
